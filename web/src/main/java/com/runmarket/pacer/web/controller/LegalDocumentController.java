            ...
            List.of(
                    ...
                    LegalSection.of("제1조 (수집하는 개인정보 항목 및 수집 방법)",
                            orderedList(
                                    ...
                                    item("위치 기반 서비스 이용 정보: GPS 기반 실시간 위치 정보 (위도, 경도, 이동 속도)",
                                            item("러닝 모드 및 관전 모드 이용 시 실시간 이동 경로 표시, 페이스 및 거리 산출, 라이브 위치 공유, 백그라운드 러닝 트래킹을 위해 수집·처리됩니다.")
                                    ),
                    ...
                    LegalSection.of("제2조 (개인정보의 처리 목적)",
                            ...
                            orderedList(
                                    ...
                                    item("러닝 중 실시간 GPS 위치 공유, 페이스/거리 산출 및 라이브 관전 기능 제공"),
